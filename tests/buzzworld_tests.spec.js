...
test.describe('all tests', async () => {
  ...
  test('Create Job and Sales Order For Repair Quotes', async ({ }, testInfo) => {
  ...
  test('Create Job and Sales Order For System Quotes', async ({ }, testInfo) => {
    //create system quote
  ...
  test('Create SO For Parts Quotes', async ({ }, testInfo) => {
    //create parts quote
  ...
  test('Verifying Buy Price and Sell Price values at Non SPA', async ({ }, testInfo) => {
    ...
    // results = await nonSPAPrice(page, customer, items[0], '26', '256.56', 'Discount', '58', 2, quoteURL, '');
    // await returnResult(page, testName, results[0]);
