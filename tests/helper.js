...
export async function api_responses(page, api_url) {
    ...
    const response = await page.evaluate(async (url) => {
        const fetchData = await fetch(url, {
            headers: {
                'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..WJhOfoQ_88LU7h4Ecf-RLzfbW5UEvQe04AsSsFeHr4VixY_-hL8JwQN0RusSFCveWgWlrGukJBCkESlttxMzjWVAh6lsItXoArykWX-TL0qWoaguWRzXk0bMiUuoHPYFU_BRtJa_GvG8g02_vFMUXL3XYnfKps5pMs7ytKM3gNzhGU6JwbsCCOftRk8CSU34HSxbtXY0Wq9hHcYuPowP7u03_XWRMFkzoO7fc8hg8jjpI0Vt741HjT1CHqNvU1pqckjZiid9ZBTn_Uo4vAVxIjyEW_QpyFVMxDg5bx4aoq2wUXbILncZHfG-Isy15rWSyOtNwzZnSc6_pq7Y_Oxwqk2rN_LaMnORzECFOry2LDg5FMqEkm5EvGUiNnIfwT4_LgKuTd9PAGrkfX_iHjl0XWLgOP5f9f9u_OLynuysKoCeAFj8-kcD0NdtVr3KyErphD7xYbj-LSJK3G5uDmW4VnecJkIFl1zJJp4_R5cD9DfrDOzfUiduJWq8oJzNShoDqnQkdopxiEGi4Lc9JO7TP-VUgksUQp9ELUc8I5iVIwYOlZo4aVaLydRhGwO2oxJv_on8hFxT16M2xXHsfI0_vrsTdU3cDp5sX26vL3-4CWvnERrzY-n2Rkxr24yBc10q16iAYnr1feMRQaS7kZgyMFnlX7M_7M_ZrtHrV1l7A9o' // Replace 'Bearer' with the appropriate authentication scheme (e.g., 'Bearer', 'Basic')
            }
        });
        return fetchData.json();
    }, api_url);
