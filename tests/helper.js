...
export async function api_responses(page, api_url) {
    ...
    const response = await page.evaluate(async (url) => {
        const fetchData = await fetch(url, {
            headers: {
                'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..IKGUpYxDuGTscKSFZughL2WpD0fO0N7_h3glu5GD4xsZV5lQ5pEr6Q61Hxydpk0l4q68--RszP1yrIRUMWe6hGEC7IfTlUMvoiC1lA6fjOjbge8Zjla1BO5UsVeTfhMDPg1j8brdClP8zf-kcS8x9heGOSieJUU7qCYJGsFRx-xx28ZgUNdy6uNONl8JWuZwXKh0zEbjfptXBsAJTB76wiof8HrFgnfc7qNeGF-reScDJMBeyQIxs-s5VBPdVMXDvqIgcz_NcLwNTOnG40i9wtz4uALO9sbJgMVh_C-m1GqsQ8BuznLyL1t6ou1OOtn0Ydod7trFL0xuok2uOt2HxJr8kLxl6mAduZEdu0wPJQOn3zYCTnEExEzPUUXFaspQDgrFShfBKz69u0PjX4tVCz1FPTp_YGvjUquuSX_HM39svvGCUbeQesI8HbG9A4BGvc9JaasSDu_KFT8aosbGk0q9bjz-xUcIUblyrIMxDuNUxSJmGj0Vn-yH6cFZGucsyKBx8cvSg_RzXkTbFC_aRcgaXOxVPEh_l_3XJxnBzmJUaz0ZcLJ3M5gqjwaQlNAyLDmrs9kDCprsHbUfv-PBOk907oFpPIuRuGLFZl53UzQOPqlPY8zsxIaSC9ksIvk5BOebdKxyR7MacwmlZppulnThJQ7K_eUa6V7NpdAgWxM' // Replace 'Bearer' with the appropriate authentication scheme (e.g., 'Bearer', 'Basic')
            }
        });
        return fetchData.json();
    }, api_url);
